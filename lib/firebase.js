...
import { getFirestore, doc, setDoc, getDoc, writeBatch, onSnapshot } from 'firebase/firestore';
...
const firestore = getFirestore(firebase);
 ...
 export { auth, googleAuthProvider, signInWithPopup, firestore, doc, setDoc, getDoc, writeBatch, onSnapshot };
